...
rulePatternCatSubcat = [
    ...
    ('ODCHOZÍ PLATBA DO JINÉ BANKY:DŮCHODOVÉ POJIŠTĚNÍ:DŮCHODOVÉ POJIŠTĚNÍ PSSZ TROJSKÁ 1997/13A 182 00 PRAHA 8 .*',
     'Superživnost:PSSZ'),
    ('ODCHOZÍ PLATBA DO JINÉ BANKY:ZDRAVOTNÍ POJIŠTĚNÍ ZA .*:ZDRAVOTNÍ POJIŠTĚNÍ VZP : .*',
     'Superživnost:VZP'),
    ('PŘÍCHOZÍ PLATBA Z JINÉ BANKY:Dateio s.r.o. :.*', 'Superživnost:Příjmy'),
    ('PŘÍCHOZÍ PLATBA Z JINÉ BANKY:YOUR SYSTEM, .*', 'Superživnost:Příjmy'),
    ...
    ('PŘÍCHOZÍ PLATBA Z JINÉ BANKY:OKsystem a.s. .*', 'Příjmy:Mzda'),
    ...
    ('FRUITISIMO - NOVY S PLZENSKA 8, PRAHA 5, 155 00, 15', 'Jídlo:Jídlo mimo domov'),
    ('Brave Heart s.r.o. Vitezna 15, Praha, 150 00, CZE', 'Jídlo:Jídlo mimo domov'),
    ...
    ('Daň z peněz získaných úročením .*', 'Účty a faktury:Bankovní poplatky'),
    ('Peníze získané úročením tohoto účtu .*', 'Účty a faktury:Bankovní poplatky'),
    ...
    ('prispevek pece o seniory .*', 'Zdravotní péče:Péče o seniory'),
    ...
    ('ZŘÍZENÍ ÚČTU', 'Účty a faktury:Bankovní poplatky'),
    ('Připsání odměn', 'Účty a faktury:Bankovní poplatky'),
    ('ZÚČTOVÁNÍ ÚROKŮ', 'Účty a faktury:Bankovní poplatky'),
    ('Peníze získané úročením .*', 'Účty a faktury:Bankovní poplatky'),
    ('PROFI AUTO CZ.*', 'Automobil:Benzín'),
    ('ODCHOZÍ PLATBA DO JINÉ BANKY:PRONAJEM GARAZOVE STANI .*', 'Automobil:parkování'),
    ('SHELL.*', 'Automobil:Benzín'),
    ('ODCHOZÍ PLATBA DO JINÉ BANKY:DPH .*FINANČNÍ ÚŘAD.*', 'Superživnost:DPH'),
