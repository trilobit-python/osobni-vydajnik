...
#   pattern, categname:subcatname
    ('ODCHOZÍ PLATBA DO JINÉ BANKY:PŘEVOD PROSTŘEDKŮ:ŠKOFIN :\'000000-0017145783/0300\':0001130887', 'Automobil:Splátky pořízení'),
    ...
    ('ODCHOZÍ PLATBA DO JINÉ BANKY:POPLATKY TELEVIZE A ROZHLAS:008029-1800060583/0300:0558:8880165467', 'Účty a faktury:TV a rozhlas'),
    ...
    ('ODCHOZÍ PLATBA DO JINÉ BANKY:SPLÁTKA KREDITNÍ KARTY:SPLÁTKA KREDITNÍ KARTA RAIFFEISENBANK :.*', 'Převod účet-účet:'),
    ...
    ('ODCHOZÍ PLATBA DO JINÉ BANKY:PRE ZÁLOHY ELEKTŘINA NĚMCOVI:000019-2784000277/0100:0020127161', 'Účty a faktury:Elektřina'),
    ('ODCHOZÍ PLATBA DO JINÉ BANKY:MATĚJ STAVEBNÍ SPOŘENÍ:000000-5714627801/7960:0611124459', 'Spoření:Matěj spoření'),
    ('ODCHOZÍ PLATBA DO JINÉ BANKY:MATĚJ STAVEBNÍ SPOŘENÍ:ČMSS STAVEBNÍ SPOŘENÍ.*000000-5714627502/7960.*0611124459', 'Spoření:Matěj spoření'),
    ('ODCHOZÍ PLATBA DO JINÉ BANKY:MATĚJ STAVEBNÍ SPOŘENÍ:000000-5714627801/7960:0611124459', 'Spoření:Matěj spoření'),
    ...
    ('ODCHOZÍ PLATBA DO JINÉ BANKY:PŘEVOD PROSTŘEDKŮ GREENPEACE:000000-0201123744/0300:0000100744:0000000308', 'Zábava:Dobročinnost'),
...
def set_stavebni_sporeni(CategoryRules, curInput, curUpdate):
    ...
    local_stavebni_sporeni_update(curInput, curUpdate, "Spoření:Matěj spoření", "Stavební spoření Matěj")
    local_stavebni_sporeni_update(curInput, curUpdate, "Spoření:Stavební spoření", "Stavební spoření")
    print()
